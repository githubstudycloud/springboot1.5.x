...
2. **版本对照表**：在官网上，可以找到一个版本对照表，列出了Spring Cloud与Spring Boot以及其他组件的兼容版本。
...
##### Spring Boot 2.7.x 稳定组件版本 (使用 Spring Cloud Alibaba)
...
##### Spring Boot 3.x 稳定组件版本 (不使用 Spring Cloud Alibaba)
